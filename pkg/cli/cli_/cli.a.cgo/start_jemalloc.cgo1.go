...
//line com_github_cockroachdb_cockroach/pkg/cli/start_jemalloc.go:1:1
...
func init() {
	if ( /*line :135:5*/_Cfunc_is_profiling_enabled /*line :135:26*/)() {
		profiler.SetJemallocHeapDumpFn(writeJemallocProfile)
	}

	var opts  /*line :139:11*/_Ctype_JemallocOpts /*line :139:25*/
	if res, _ := func() (_Ctype_int, error){ _cgoBase0 := /*line :140:35*/&opts; _cgo0 := _cgoBase0; _cgoCheckPointer(_cgoBase0, 0 == 0); return /*line :140:41*/_C2func_jemalloc_get_opts(_cgo0); }(); res != 0 {
		...
		cgoAllocConfStr = fmt.Sprintf("prof:%t,prof_active:%t,background_thread:%t,thp:%s,metadata_thp:%s,narenas:%d,dirty_decay_ms:%d,muzzy_decay_ms:%d",
			...
			( /*line :147:4*/_Cfunc_GoString /*line :147:13*/)(opts.thp),
			( /*line :148:4*/_Cfunc_GoString /*line :148:13*/)(opts.metadata_thp),
			int(opts.narenas),
...
func writeJemallocProfile(filename string) error {
	cpath := ( /*line :159:11*/_Cfunc_CString /*line :159:19*/)(filename)
	defer func() func() { _cgo0 := /*line :160:15*/unsafe.Pointer(cpath); return func() { _cgoCheckPointer(_cgo0, nil); /*line :160:37*/_Cfunc_free(_cgo0); }}()()

	if errCode := ( /*line :162:16*/_Cfunc_dump_heap_profile /*line :162:34*/)(cpath); errCode != 0 {
