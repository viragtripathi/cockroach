...
import (
	...
	_ "pkg/spanconfig/spanconfigreconciler/spanconfigreconciler_test"

	_ "pkg/spanconfig/spanconfigreconciler/spanconfigreconciler_test_test"
...
func main() {
	...
	if bzltestutil.ShouldWrap() {
		err := bzltestutil.Wrap("pkg/spanconfig/spanconfigreconciler/spanconfigreconciler_test")
		exitCode := 0
