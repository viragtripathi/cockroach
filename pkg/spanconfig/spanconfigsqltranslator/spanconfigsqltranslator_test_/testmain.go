...
import (
	...
	_ "pkg/spanconfig/spanconfigsqltranslator/spanconfigsqltranslator_test"

	_ "pkg/spanconfig/spanconfigsqltranslator/spanconfigsqltranslator_test_test"
...
func main() {
	...
	if bzltestutil.ShouldWrap() {
		err := bzltestutil.Wrap("pkg/spanconfig/spanconfigsqltranslator/spanconfigsqltranslator_test")
		exitCode := 0
