...
import (
	...
	_ "pkg/bench/hashbench/hashbench_test_test"

	l "pkg/bench/hashbench/hashbench_test"
...
var benchmarks = []testing.InternalBenchmark{
	...
	{"BenchmarkLatencyWhileHashing", l.BenchmarkLatencyWhileHashing },
...
func main() {
	...
	if bzltestutil.ShouldWrap() {
		err := bzltestutil.Wrap("pkg/bench/hashbench/hashbench_test")
		exitCode := 0
