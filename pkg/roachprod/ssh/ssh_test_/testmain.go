...
import (
	...
	_ "github.com/cockroachdb/cockroach/pkg/roachprod/ssh_test"

	l "github.com/cockroachdb/cockroach/pkg/roachprod/ssh"

)

var allTests = []testing.InternalTest{

	{"TestProgress", l.TestProgress },
...
func main() {
	...
	if bzltestutil.ShouldWrap() {
		err := bzltestutil.Wrap("github.com/cockroachdb/cockroach/pkg/roachprod/ssh")
		exitCode := 0
