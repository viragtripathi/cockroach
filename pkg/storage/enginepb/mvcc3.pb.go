...
type MVCCValueHeader struct {
	...
	// Replication stream.
	OriginTimestamp github_com_cockroachdb_cockroach_pkg_util_hlc.Timestamp `protobuf:"bytes,6,opt,name=origin_timestamp,json=originTimestamp,proto3,casttype=github.com/cockroachdb/cockroach/pkg/util/hlc.Timestamp" json:"origin_timestamp"`
}
...
type MVCCCommitIntentOp struct {
	...
	// Replication. 0 identifies a local write, 1 identifies a remote write, and
	// 2+ are reserved to identify remote clusters.
	OriginID uint32 `protobuf:"varint,7,opt,name=origin_id,json=originId,proto3" json:"origin_id,omitempty"`
}
...
var fileDescriptor_6599d13285d4d9cc = []byte{
	...
	,
}
...
func (this *MVCCValueHeader) Equal(that interface{}) bool {
	...
	if !this.OriginTimestamp.Equal(&that1.OriginTimestamp) {
		return false
	}
	return true
}
...
func (m *MVCCValueHeader) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *MVCCValueHeader) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *MVCCValueHeader) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	// Field has gogoproto.omitempty set.
	if !m.OriginTimestamp.IsEmpty() {
		{
	...
	if m.OriginID != 0 {
		i = encodeVarintMvcc3(dAtA, i, uint64(m.OriginID))
		i--
		dAtA[i] = 0x28
	}
	if m.ImportEpoch != 0 {
...
func (m *MVCCValueHeader) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.OriginID != 0 {
		n += 1 + sovMvcc3(uint64(m.OriginID))
	}
	// Field has gogoproto.omitempty set.
	if !m.OriginTimestamp.IsEmpty() {
