...
const (
	...
	MsgDeFortifyLeader   MessageType = 26
)
...
var MessageType_name = map[int32]string{
	...
	23: "MsgForgetLeader",
	24: "MsgFortifyLeader",
	25: "MsgFortifyLeaderResp",
	26: "MsgDeFortifyLeader",
}
...
type Message struct {
	...
	To   PeerID      `protobuf:"varint,2,opt,name=to,casttype=PeerID" json:"to"`
	From PeerID      `protobuf:"varint,3,opt,name=from,casttype=PeerID" json:"from"`
	...
	LeadEpoch Epoch   `protobuf:"varint,17,opt,name=leadEpoch,casttype=Epoch" json:"leadEpoch"`
	...
	Match uint64 `protobuf:"varint,15,opt,name=match" json:"match"`
}
...
type HardState struct {
	...
	Vote      PeerID `protobuf:"varint,2,opt,name=vote,casttype=PeerID" json:"vote"`
	Commit    uint64 `protobuf:"varint,3,opt,name=commit" json:"commit"`
	Lead      PeerID `protobuf:"varint,4,opt,name=lead,casttype=PeerID" json:"lead"`
	LeadEpoch Epoch  `protobuf:"varint,5,opt,name=lead_epoch,json=leadEpoch,casttype=Epoch" json:"lead_epoch"`
}
...
type ConfState struct {
	...
	Voters []PeerID `protobuf:"varint,1,rep,name=voters,casttype=PeerID" json:"voters,omitempty"`
	// The learners in the incoming config.
	Learners []PeerID `protobuf:"varint,2,rep,name=learners,casttype=PeerID" json:"learners,omitempty"`
	// The voters in the outgoing config.
	VotersOutgoing []PeerID `protobuf:"varint,3,rep,name=voters_outgoing,json=votersOutgoing,casttype=PeerID" json:"voters_outgoing,omitempty"`
	...
	LearnersNext []PeerID `protobuf:"varint,4,rep,name=learners_next,json=learnersNext,casttype=PeerID" json:"learners_next,omitempty"`
...
type ConfChange struct {
	...
	NodeID  PeerID         `protobuf:"varint,3,opt,name=node_id,json=nodeId,casttype=PeerID" json:"node_id"`
...
type ConfChangeSingle struct {
	...
	NodeID PeerID         `protobuf:"varint,2,opt,name=node_id,json=nodeId,casttype=PeerID" json:"node_id"`
}
...
var fileDescriptor_1e9d4c87982c6a6a = []byte{
	...
	,
}
...
func (m *Message) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	i = encodeVarintRaft(dAtA, i, uint64(m.LeadEpoch))
	i--
	dAtA[i] = 0x1
	i--
	dAtA[i] = 0x88
...
func (m *Message) Size() (n int) {
	...
	n += 2 + sovRaft(uint64(m.LeadEpoch))
	return n
}
...
func (m *HardState) Size() (n int) {
	...
	n += 1 + sovRaft(uint64(m.LeadEpoch))
	return n
}
...
func (m *Message) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 17:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LeadEpoch", wireType)
			}
			m.LeadEpoch = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LeadEpoch |= Epoch(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
	...
	for iNdEx < l {
		...
		case 1:
			if wireType == 0 {
				...
				if elementCount != 0 {
					if m.Voters == nil {
						m.Voters = make([]PeerID, 0, elementCount)
					} else {
						m.Voters = slices.Grow(m.Voters, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v PeerID
		...
		case 2:
			if wireType == 0 {
				...
				if elementCount != 0 {
					if m.Learners == nil {
						m.Learners = make([]PeerID, 0, elementCount)
					} else {
						m.Learners = slices.Grow(m.Learners, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v PeerID
		...
		case 3:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.VotersOutgoing == nil {
						m.VotersOutgoing = make([]PeerID, 0, elementCount)
					} else {
						m.VotersOutgoing = slices.Grow(m.VotersOutgoing, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v PeerID
		...
		case 4:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.LearnersNext == nil {
						m.LearnersNext = make([]PeerID, 0, elementCount)
					} else {
						m.LearnersNext = slices.Grow(m.LearnersNext, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v PeerID
