...
//line com_github_cockroachdb_cockroach/pkg/server/status/runtime_jemalloc.go:1:1
...
func getJemallocStats(ctx context.Context) (cgoAlloc uint, cgoTotal uint, _ error) {
	var js  /*line :129:9*/_Ctype_JemallocStats /*line :129:24*/
	// TODO(marc): should we panic here? Failure on fetching the stats may be a problem.
	if _, err := ( /*line :131:15*/_C2func_jemalloc_get_stats /*line :131:34*/)(&js); err != nil {
		return 0, 0, err
	}
	...
	if log.V(2) {
		...
		for i := 0; i < v.NumField(); i++ {
			stats[i] = t.Field(i).Name + ": " + humanize.IBytes(uint64(v.Field(i).Interface().( /*line :141:87*/_Ctype_size_t /*line :141:95*/)))
		}
	...
	if log.V(1) && !log.V(math.MaxInt32) {
		if log.V(3) {
			...
			( /*line :153:4*/_Cfunc_je_malloc_stats_print /*line :153:26*/)(nil, nil, nil)
		} else {
			// Abbreviated jemalloc stats (does not include per-arena stats).
			( /*line :156:4*/_Cfunc_jemalloc_stats_print_abbreviated /*line :156:37*/)()
		}
	}
...
func allocateMemory() {
	...
	( /*line :178:2*/_Cfunc__CMalloc /*line :178:9*/)(256 << 10)
}
...
func jemallocMaybePurge(
	...
	res, err := ( /*line :222:14*/_C2func_jemalloc_purge /*line :222:29*/)()
	if err != nil || res != 0 {
