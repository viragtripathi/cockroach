...
type ScanLockingDurability int32

const (
	ScanLockingDurability_BEST_EFFORT ScanLockingDurability = 0
	ScanLockingDurability_GUARANTEED  ScanLockingDurability = 1
)

var ScanLockingDurability_name = map[int32]string{
	0: "BEST_EFFORT",
	1: "GUARANTEED",
}

var ScanLockingDurability_value = map[string]int32{
	"BEST_EFFORT": 0,
	"GUARANTEED":  1,
}

func (x ScanLockingDurability) Enum() *ScanLockingDurability {
	p := new(ScanLockingDurability)
	*p = x
	return p
}

func (x ScanLockingDurability) String() string {
	return proto.EnumName(ScanLockingDurability_name, int32(x))
}

func (x *ScanLockingDurability) UnmarshalJSON(data []byte) error {
	value, err := proto.UnmarshalJSONEnum(ScanLockingDurability_value, data, "ScanLockingDurability")
	if err != nil {
		return err
	}
	*x = ScanLockingDurability(value)
	return nil
}

func (ScanLockingDurability) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_484351bd13f4281f, []int{2}
}
...
func init() {
	...
	proto.RegisterEnum("cockroach.sql.sqlbase.ScanLockingDurability", ScanLockingDurability_name, ScanLockingDurability_value)
}
...
var fileDescriptor_484351bd13f4281f = []byte{
	...
	,
}
