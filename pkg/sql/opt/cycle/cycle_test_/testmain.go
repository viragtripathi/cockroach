...
import (
	...
	_ "github.com/cockroachdb/cockroach/pkg/sql/opt/cycle_test"

	l "github.com/cockroachdb/cockroach/pkg/sql/opt/cycle"

)

var allTests = []testing.InternalTest{

	{"TestDetector", l.TestDetector },
...
func main() {
	...
	if bzltestutil.ShouldWrap() {
		err := bzltestutil.Wrap("github.com/cockroachdb/cockroach/pkg/sql/opt/cycle")
		exitCode := 0
