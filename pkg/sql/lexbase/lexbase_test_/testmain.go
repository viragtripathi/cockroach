...
import (
	...
	_ "pkg/sql/lexbase/lexbase_test"

	l_test "pkg/sql/lexbase/lexbase_test_test"

)

var allTests = []testing.InternalTest{

	{"TestEncodeRestrictedSQLIdent", l_test.TestEncodeRestrictedSQLIdent },

	{"TestEncodeSQLBytes", l_test.TestEncodeSQLBytes },

	{"TestEncodeSQLString", l_test.TestEncodeSQLString },

	{"TestEncodeSQLStringSpecial", l_test.TestEncodeSQLStringSpecial },

}

var benchmarks = []testing.InternalBenchmark{

	{"BenchmarkEncodeSQLString", l_test.BenchmarkEncodeSQLString },

	{"BenchmarkEncodeNonASCIISQLString", l_test.BenchmarkEncodeNonASCIISQLString },
...
func main() {
	...
	if bzltestutil.ShouldWrap() {
		err := bzltestutil.Wrap("pkg/sql/lexbase/lexbase_test")
		exitCode := 0
