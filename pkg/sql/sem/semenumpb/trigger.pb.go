...
func init() {
	proto.RegisterEnum("cockroach.sql.sem.semenumpb.TriggerActionTime", TriggerActionTime_name, TriggerActionTime_value)
	proto.RegisterEnum("cockroach.sql.sem.semenumpb.TriggerEventType", TriggerEventType_name, TriggerEventType_value)
}
