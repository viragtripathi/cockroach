...
func (m *SpanConfigConformanceReport) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.UnavailableNodeIDs) > 0 {
		...
		i -= l
		if l == len(m.UnavailableNodeIDs) {
			dest := dAtA[i : i+len(m.UnavailableNodeIDs)]
			for k, num := range m.UnavailableNodeIDs {
				dest[k] = uint8(num)
			}
		} else {
			j13 := i
		...
		i = encodeVarintSpanConfig(dAtA, i, uint64(uint64(l)))
		i--
		dAtA[i] = 0x2a
	}
...
func (m *SystemSpanConfigTarget_Type) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			alloc := new(struct {
				value SystemSpanConfigTarget_Type_SpecificTenantKeyspace
				field SystemSpanConfigTarget_TenantKeyspace
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.SpecificTenantKeyspace = &alloc.field
			m.Type = &alloc.value
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			alloc := new(struct {
				value SystemSpanConfigTarget_Type_EntireKeyspace
				field SystemSpanConfigTarget_EntireKeyspace
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.EntireKeyspace = &alloc.field
			m.Type = &alloc.value
			iNdEx = postIndex
		case 3:
			if wireType != 2 {
			...
			alloc := new(struct {
				value SystemSpanConfigTarget_Type_AllTenantKeyspaceTargetsSet
				field SystemSpanConfigTarget_AllTenantKeyspaceTargetsSet
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.AllTenantKeyspaceTargetsSet = &alloc.field
			m.Type = &alloc.value
			iNdEx = postIndex
		default:
			iNdEx = preIndex
...
func (m *SpanConfigTarget) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 1:
			...
			alloc := new(struct {
				value SpanConfigTarget_Span
				field Span
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.Span = &alloc.field
			m.Union = &alloc.value
			iNdEx = postIndex
		case 2:
			if wireType != 2 {
			...
			alloc := new(struct {
				value SpanConfigTarget_SystemSpanConfigTarget
				field SystemSpanConfigTarget
			})
			if err := alloc.field.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			alloc.value.SystemSpanConfigTarget = &alloc.field
			m.Union = &alloc.value
			iNdEx = postIndex
		default:
			iNdEx = preIndex
	...
	for iNdEx < l {
		...
		case 5:
			if wireType == 0 {
				...
				elementCount = count
				if elementCount != 0 {
					if m.UnavailableNodeIDs == nil {
						m.UnavailableNodeIDs = make([]int32, 0, elementCount)
					} else {
						m.UnavailableNodeIDs = slices.Grow(m.UnavailableNodeIDs, elementCount)
					}
				}
				for iNdEx < postIndex {
					var v int32
